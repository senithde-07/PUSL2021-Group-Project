        ...
        <div class="box-border h-25 w-full p-4 border-4 ...">
            <div class="grid grid-cols-3 gap-4 mb-2">
                <div class="flex items-center justify-self-start ">
                    <h1 class="font-bold text-4xl uppercase">Change Password</h1>
                </div>
...
<div class="p-4 sm:ml-64">
    <form method="post" action="changepassword">
        <div class="mb-6 mt-5">
            <label for="text" class="block mb-2 text-sm font-medium text-black font-bold uppercase dark:text-white">Current
                Password</label>
            <input type="password" id="" value="" name="currentpw"
                   class="bg-gray-50 border border-green-500 text-gray-900 text-sm rounded-lg  block w-full p-2.5 "
                   placeholder="" required>
        </div>

        <div class="mb-6 mt-5">
            <label for="text" class="block mb-2 text-sm font-medium text-black font-bold uppercase dark:text-white">New
                Password</label>
            <input type="password" id="pw" value="" name="id"
                   class="bg-gray-50 border border-green-500 text-gray-900 text-sm rounded-lg  block w-full p-2.5 "
                   placeholder="" required>
        </div>

        <div class="mb-6 mt-5">
            <label for="text" class="block mb-2 text-sm font-medium text-black font-bold uppercase dark:text-white">Confirm
                Password</label>
            <input type="password" id="pw1" value="" name="newpw"
                   class="bg-gray-50 border border-green-500 text-gray-900 text-sm rounded-lg  block w-full p-2.5 "
                   placeholder="" required>
        </div>
...
<script>
    ...
    var password = document.getElementById("pw")
        , confirm_password = document.getElementById("pw1");
