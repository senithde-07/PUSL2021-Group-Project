...
<div id="mySidenav" class="sidenav">
    ...
    <a href="timetable.jsp" class="icon-a font-bold"><i class="fa fa-calendar"></i> &nbsp;&nbsp;Add Timetable</a>
...
<div id="main">
    ...
    <div class="head">
        <div class="col-div-6 font-bold">
            <span style="font-size:30px;cursor:pointer; color: rgb(0, 0, 0);" class="nav">&#9776; Add Timetable</span>
            <span style="font-size:30px;cursor:pointer; color: rgb(0, 0, 0);" class="nav2">&#9776; Add Timetable</span>
        </div>
